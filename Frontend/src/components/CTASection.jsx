  ...
  return (
    <div className="bg-[#00236F] text-white py-16 px-6 text-center">
      ...
      <div className="flex justify-center gap-4 mt-8">
        <button className="bg-white text-[#00236F] font-bold text-xs px-6 py-3 rounded-xl hover:bg-gray-100 transition-colors">
          Get Started Today
        </button>
        <button className="border border-blue-400 text-white font-bold text-xs px-6 py-3 rounded-xl hover:bg-blue-900 transition-colors">
          Talk to an Expert
        </button>
      </div>
    </div>
